...
#setwd("Set the location of the working directory here")
setwd("D:/NFMS_NFA_FAO_WB2018_9/March2019/S2A_Mosaics2019")

# Input shapefiles with training data
#shapefileDSN <- 'Navigate or paste the path of the shapefile with training data here'
...
image <- stack("Path to input image to be classified")
...
outImage1 <- superClass(image, vec1, valData = NULL, responseCol = "ID",
                                  ...
                                  filename = "Uganda2017SupClass.tif", verbose=TRUE, overwrite = TRUE)
